...
var customDataWaitForConfig = [
  ...
  { on: function() { return Invoca.Client.parseCustomDataField("session_ai_id", "Last", "URLParam", ""); }, paramName: "session_ai_id", fallbackValue: null },
...
const campaignId = {
	...
	services_decombine: "services_decombine"
};
...
const url_list = {
	...
	service_cancel_flow: [
		...
		"www.directv.com/support/satellite/article/000092807",
		"www.directv.com/support/article/000092807",
		"www.directv.com/support/cancel-help/ai"
    ],
    ...
    // services_decombine: [
    //     "www.directv.com/support/article/000013994"
    // ]
};
...
// 		{ check: () => Invoca.Client.isURLMatch(url_list.services_decombine), id: campaignId.services_decombine },
...
var generatedOptions = {
  ...
  disableUrlParams:    ['StreamEquipment','buy_flow_dest_num','buy_flow_num_tfnid','buy_flow_num_utm_id','consent_cookie','dtvb_base_package','dtvb_call_disposition_reason','invoca_destination_number','ipbb','page_intent','s','utm_medium','utm_source'],
